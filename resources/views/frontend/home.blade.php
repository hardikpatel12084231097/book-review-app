    ...
    <div class="row justify-content-center d-flex mt-5">
        <div class="col-md-12">
            <div class="d-flex justify-content-between">
                ...
                <div class="mt-2">
                    <a href="{{route('home')}}" class="text-white btn btn-primary" >Clear</a>
                </div>
            </div>
                ...
                <div class="card-body">    
                    <div class="row">
                        <div class="col-lg-11 col-md-11">
                            <input type="text" name="keywords" class="form-control form-control-lg" placeholder="Search by title">
                        </div>
